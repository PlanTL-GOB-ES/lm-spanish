...
def main():
    ...
    metric = load_metric("/gpfs/projects/bsc88/projects/bne/eval_amd/metrics/squad_v2" if data_args.version_2_with_negative else "/gpfs/projects/bsc88/projects/bne/eval_amd/metrics/squad")
